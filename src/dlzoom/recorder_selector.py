...
class RecordingSelector:
    ...
    def select_best_audio(self, recording_files: List[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
    ...
    def select_most_recent_instance(self, instances: List[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
    ...
    def filter_by_uuid(self, instances: List[Dict[str, Any]], uuid: str) -> Optional[Dict[str, Any]]:
