...
class TestDownloadFlowIntegration:
    ...
    def test_downloader_receives_correct_access_token_s2s(
        ...
        with patch("dlzoom.handlers.Downloader") as MockDownloader:
            ...
            mock_downloader_instance.download_file = Mock(
                return_value=tmp_path / "test.m4a"
            )
            ...
            call_args = MockDownloader.call_args
    ...
    def test_downloader_receives_correct_access_token_user_oauth(
        ...
        with patch("dlzoom.handlers.Downloader") as MockDownloader:
            ...
            mock_downloader_instance.download_file = Mock(
                return_value=tmp_path / "user_test.m4a"
            )
            mock_downloader_instance.download_transcripts_and_chat = Mock(
                return_value={"vtt": None, "txt": None, "timeline": None}
            )
    ...
    def test_download_with_real_downloader_constructor(
        ...
        with patch("dlzoom.handlers.Downloader.download_file") as mock_download:
            with patch("dlzoom.handlers.Downloader.download_transcripts_and_chat") as mock_transcripts:
                ...
                try:
                    ...
                    if "takes 2 positional arguments but 3 were given" in str(e):
                        pytest.fail(
                            ...
                            "This indicates the old bug where output_name was passed as access_token"
                        )
                    raise
